...
const educacion = ref([
  {fecha: '2020', title: 'Técnico en Reparación y Mantenimiento de Celulares', descripcion: 'Negocio propio en Reparación y Mantenimiento de celulares, computadoras, etc.', enlace:'http://www.facebook.com/'},
  {fecha: '2020', title: 'Microelectronica de Celulares', descripcion: 'Negocio pripio en diagnosticando y solucionando fallas de hardware y software, a menudo en el nivel de los circuitos integrados.', enlace:'http://www.facebook.com/'},
