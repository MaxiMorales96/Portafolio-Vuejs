...
const title = 'Maximiliano A Morales';
const descripcion = 'Estudiante de Técnico Universitario en Programación - UTN';
const residencia = 'Gral. Roca, RN, Argentina';
const presentacion = 'Hola, Bienvenido a mi portafolio de proyectos. Soy un estudiante en programación.';
const redesSociales = [
  { id: 1, name: 'linkedin', src: linkedin, url: 'https://www.linkedin.com/in/maxi-morales-9b4541393/' },
  { id: 2, name: 'Instagram', src: instagram, url: 'https://www.instagram.com/m.a.mor712/' },
  { id: 3, name: 'github', src: github, url: 'https://github.com/MaxiMorales96' },
  { id: 4, name: 'curriculum', src: cv, url: '' },
];
const telefono = '+54 9 2984-661349';
</script>
